...
#ifndef ZEPHYR_INCLUDE_DRIVERS_CAMERA_ARDUMEGA_MEGA_H_
#define ZEPHYR_INCLUDE_DRIVERS_CAMERA_ARDUMEGA_MEGA_H_
...
#define VIDEO_CID_ARDUCAM_AUTO_WHITE_BAL (VIDEO_CTRL_CLASS_VENDOR + 6)
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_CAMERA_ARDUMEGA_MEGA_H_ */
