...
enum arducam_buffer_flag {
	ARDUCAM_VIDEO_BUF_START,
	ARDUCAM_VIDEO_BUF_MORE,
	ARDUCAM_VIDEO_BUF_DONE
};

enum arducam_frame_mode {
	ARDUCAM_FRAME_FRAGMENTED,
	ARDUCAM_FRAME_COMPLETE,
};

struct arducam_video_buffer {
	unsigned int frame_length;
	enum arducam_frame_mode mode;
	enum arducam_buffer_flag flag;
};
